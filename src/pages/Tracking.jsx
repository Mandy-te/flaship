...
const mockTrackingData = {
  "FL123456": {
    ...
    history: [
      { location: "Miami, FL", state: "Expédié", date: "2025-10-05T15:00:00Z" },
      { location: "Port-au-Prince", state: "Arrivé", date: "2025-10-06T09:30:00Z" },
    ],
  },
  "FL654321": {
    trackingNumber: "FL654321",
    status: "Livré",
    location: "Cap-Haïtien, Haïti",
    lastUpdate: "2025-10-06T18:45:00Z",
    history: [
      { location: "Miami, FL", state: "Expédié", date: "2025-10-03T12:00:00Z" },
      { location: "Port-au-Prince", state: "Arrivé", date: "2025-10-05T09:00:00Z" },
    ],
  },
};
...
export default function Tracking() {
  ...
  const handleTrack = () => {
    ...
    setTimeout(() => {
      ...
      else setError("Colis introuvable. Vérifiez le numéro.");
      setLoading(false);
    }, 800);
  };
