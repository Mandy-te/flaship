    ...
    <header className="fixed w-full top-0 left-0 bg-white/90 backdrop-blur-md shadow-md z-50">
      <div className="flex items-center justify-between px-6 md:px-10 py-4">
        ...
        <nav className="hidden md:flex items-center space-x-6 font-medium text-gray-700">
          ...
          <Link to="/calculator" className="hover:text-blue-600 transition">Calculator</Link>
          <Link to="/services" className="hover:text-blue-600 transition">Services</Link>
          <Link to="/tarifs" className="hover:text-blue-600 transition">Tarifs</Link>
        ...
        <div className="hidden md:flex items-center space-x-3">
          <Link
            to="/login"
            className="border border-blue-700 text-blue-700 px-3 py-1.5 rounded-lg hover:bg-blue-700 hover:text-white transition text-sm"
          >
            Login
          </Link>
          <Link
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-gray-200 animate-slideDown">
          <nav className="flex flex-col p-4 space-y-3 text-center font-medium">
            <Link to="/" onClick={() => setOpen(false)}>Accueil</Link>
            <Link to="/calculator" onClick={() => setOpen(false)}>Calculator</Link>
